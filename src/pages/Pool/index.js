...
function Pool() {
    ...
    const submit = async type => {
        ...
        try {
            ...
            if(reg.test(error)) {
                message.error(error + 'it may takes longer than expected for your staked votes to be unlocked, please wait a few hours before try to withdraw again')
            }
                        ...
                        <div className="flex h-full">
                            ...
                            <div className="flex-1 border-gray-800 border-2 text-black box-border rounded bg-main-back pl-[32px] pr-[16px]">
                                ...
                                >
                                    ...
                                    <div className="font-medium my-2 text-sm text-gray-400">{t('Pool.how_much_stake')}</div>
                                    <Form.Item
                                        required
                                    ...
                                    >
                                        <Row>
                                            ...
                                            <Col span={24}>
                                                <Input
                                                    // hypnos+s
                                                    style={{ color: "#333333", width: "100%", height: 40, fontWeight: "500", background: "#F8F8F8" }}
                                    ...
                                    <div className="font-medium">
                                        ...
                                        {/* hypnos+B */}
                                        <Button
                                            style={{ border: "none", fontWeight: "500", color: "#1E3DE4" }}
                                            onClick={() => {
                                                setInputStakeCfx(cfxMaxCanStake)
                                            }}
                                        >
                                    ...
                                    <div className="flex mt-2">
                                        <Button
                                            // hypnos+s
                                            style={{ width: 140, height: 40, lineHeight: "18px", fontWeight: "500", background: "#546FFF", color: "white" }}
                                            type="primary"
                                            // size="middle" hypnos
                                            onClick={() => {
                                    ...
                                    <div className="font-medium my-2 text-sm text-gray-400">{t('Pool.how_much_unstake')}</div>
                                    <Form.Item
                                        required
                                    ...
                                    >
                                        <Row>
                                            ...
                                            <Col span={24}>
                                                <Input
                                                    // hypnos+s
                                                    style={{ color: "#333333", width: "100%", height: 40, fontWeight: "500", backgroundColor: "#F8F8F8" }}
                                                    placeholder={t('Pool.enter_cfx_amount')}
                            ...
                            <div className="flex-1 p-6 border-gray-800 border-2 box-border rounded bg-main-back text-black font-medium">
                                ...
                                <Row className="vertical-top w-full mt-4">
                                    ...
                                    <Col span={6} offset={2}>
                                        ...
                                        <br />
                                        <span className="text-m" style={{ color: "#1E3DE4" }}>{rewards}</span>
                                        <span className="text-xs text-gray-500"> CFX</span>
                                    </Col>
                                    <Col span={6} offset={2}>
                                        <span className="font-normal ">{t('Pool.performance_fee')}</span>
                                        <br />
                                ...
                                <div>
                                    ...
                                    <span className='font-normal text-base ml-6'>{t('Pool.withdrawable')}</span>
                                    {/* <span className="ml-2 font-bold">{cfxCanWithdraw}</span>
                                    <span> CFX</span> hypnos*/}
                                    <span className="float-right text-m font-bold" style={{ color: "#1E3DE4" }}>
                                        {cfxCanWithdraw}<span className='text-xs text-gray-500'> CFX</span></span>
                                    <br /><br />
                                    {/* <span className="ml-2">
                                        <Button
                                            type="primary"
